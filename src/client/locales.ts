...
export const zh = {
  ...
  copy: '复制',
  newFile: '新文件',
  newFileNamePlaceholder: '文件名，例如 notes.md',
  newFolder: '新建文件夹',
  newFolderNamePlaceholder: '文件夹名，例如 src',
  newNameInvalid: '名称不能为空，且不能包含路径分隔符（/ 或 \\）',
  create: '创建',
  revealInFileManager: '在文件管理器中打开',
  rename: '重命名',
  renamePlaceholder: '新名称',
  delete: '删除',
  deleteDesc: '将删除「{path}」。此操作不可恢复。',
  paste: '粘贴',
  copySuffix: ' 副本',
  openEditor: '打开编辑器',
  gitDetail: '查看变更详情',
  ...
  aiEdit: 'AI编辑',
  aiInstructionPlaceholder: '润色/扩写/续写',
  aiGenerating: '正在生成…',
  aiStop: '停止',
  aiRevoke: '撤回',
  aiConfirm: '确认',
  aiFailed: '生成失败',
  aiLocateFailed: '无法定位选中的文字，请在编辑模式下重新选中后重试',
  copyRelative: '复制相对地址',
  copyAbsolute: '复制绝对地址',
  download: '下载',
  settingsNav: '侧边卡片',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  pasteImageFailed: 'Image paste failed: {message}',
  ...
  copy: 'Copy',
  newFile: 'New file',
  newFileNamePlaceholder: 'File name, e.g. notes.md',
  newFolder: 'New folder',
  newFolderNamePlaceholder: 'Folder name, e.g. src',
  newNameInvalid: 'Name cannot be empty or contain path separators (/ or \\)',
  create: 'Create',
  revealInFileManager: 'Reveal in File Manager',
  rename: 'Rename',
  renamePlaceholder: 'New name',
  delete: 'Delete',
  deleteDesc: 'Delete "{path}"? This cannot be undone.',
  paste: 'Paste',
  copySuffix: ' copy',
  ...
  aiEdit: 'AI edit',
  aiInstructionPlaceholder: 'Polish/Expand/Continue',
  aiGenerating: 'Generating…',
  aiStop: 'Stop',
  aiRevoke: 'Revoke',
  aiConfirm: 'Confirm',
  aiFailed: 'Generation failed',
  aiLocateFailed: 'Could not locate the selection; please re-select it in edit mode',
